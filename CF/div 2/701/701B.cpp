...
//        int l,r;cin>>l>>r;
//        int tot = (r-l-1);
//        cout<<"total val possible "<<tot<<endl;
//        cout<<"ase "<<1<<endl;
//        cout<<"alt possible = "<<tot- 1<<endl;
//    }
    vector<ll>res(n+1),pr(n+1);
//    a[0] = 1;
//    a[n+1] = k;
    for(int i=1;i<=n;i++){
        if(i==1){
...
//    cout<<endl;
    ...
    while(q--){
        ...
        if(l==r)cout<<k-1<<"\n";
            ...
            ll res_final = pr[r-1]-pr[l];

            ll samne = a[l+1]-2;
            ll pise = k-a[r-1]-1;
//            cout<<"samne = "<<samne<<endl;
//            cout<<"pise = "<<pise<<endl;
//            cout<<"maj = "<<res_final<<endl;
            cout<<res_final+samne+pise<<endl;
        }
    }
}
int main ()
