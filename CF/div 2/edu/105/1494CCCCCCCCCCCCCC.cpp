...
string gen(string s,int a,int b,int c){
...
bool fun(string s,int a,int b,int c){
    s = gen(s,a,b,c);
    stack<char>stk;
...
void solve(){
    ...
    if(fun(s,0,0,0) || fun(s,0,0,1)|| fun(s,0,1,0)|| fun(s,1,0,0))cout<<"YES\n";
    else if(fun(s,1,1,1) || fun(s,1,1,0)|| fun(s,1,0,1)|| fun(s,0,1,1))cout<<"YES\n";
    else cout<<"NO\n";
}
int main ()
{
    //cout<<gen("AAAABBBCCC",0,1,0);
    flash;
    int t=1;cin>>t;
    while(t--)solve();
    return 0;
